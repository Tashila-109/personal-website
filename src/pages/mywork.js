            ...
            <animated.div className="Content-home" style={props}>
                <div className={myworkStyles.contentMywork}>
                    ...
                    <div className={myworkStyles.project}>
                        ...
                        <div className={myworkStyles.project__details}>
                            <img
                                src={natours}
                                alt="Project 1"
                                className={myworkStyles.imageDescription}
                            />
                            <div className={myworkStyles.descriptionBox}>
                                <p
                                ...
                                <div
                                    className={myworkStyles.descriptionButtons}
                                >
                                    <a
                                        href="#"
